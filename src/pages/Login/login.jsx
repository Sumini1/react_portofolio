...
const Login = () => {
  ...
  return (
    <div>
      <section
        className="bg-gray-50 dark:bg-gray-900 mb-0 p-0 w-[100%] h-[100vw] z-50 backdrop-blur"
        style={{
      ...
      >
        <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
          <a
            href="#"
            className="flex items-center mb-28 text-2xl font-semibold text-gray-900 dark:text-white"
          ></a>
